class Files {
  constructor(element, settings = {}) {
    ...
    let html = `
            ...
            <div class="panel-files">
                ...
                <div class="file-list-controls">
                    ...
                    <div class="div-buttons flex justify-end">
                        ...
                        ${this.refreshButton ? `
                        <button class="btn-refresh tooltipx relative ml-2" title="${this.out('Refresh')}" style="width:55px;"><svg><use xlink:href="#icon-refresh"></use></svg></button>
                        ` : ''}
                        <!--
                        <button class="btn-listview tooltipx relative ml-2" title="${this.out('List')}" style="width:55px;height:44px"><svg style="width:22px;height:22px"><use xlink:href="#icon-list"></use></svg></button>
                        <button class="btn-iconsview tooltipx relative ml-2" title="${this.out('Thumbnails')}" style="width:55px;height:44px"><svg style="width:22px;height:22px"><use xlink:href="#icon-icons"></use></svg></button>
                        <button class="btn-thumbnailview tooltipx relative ml-2 mr-5" title="${this.out('Thumbnails')}" style="width:55px;height:44px"><svg style="width:22px;height:22px"><use xlink:href="#icon-thumbnails"></use></svg></button>
                        -->
                        <button class="btn-filemore tooltipx relative ml-2" title="${this.out('File Info')}" style="width:55px;height:44px"><svg style="width:22px;height:22px"><use xlink:href="#icon-info"></use></svg></button>
                        <button class="btn-upload tooltipx relative ml-2" title="${this.out('Upload')}" style="width:55px;"><svg><use xlink:href="#icon-upload"></use></svg></button>
                        <button class="btn-folder tooltipx relative ml-2" title="${this.out('Create Folder')}" style="width:55px;"><svg><use xlink:href="#icon-folder-plus"></use></svg></button>
                        <button class="btn-rename tooltipx relative ml-2" title="${this.out('Rename')}" style="display:none;">${this.out('Rename')}</button>
                        <button class="btn-move-files tooltipx relative ml-2" title="${this.out('Move')}" style="display:none;">${this.out('Move')}</button>
                        <button class="btn-delete-files tooltipx relative ml-2" title="${this.out('Delete Selected')}" style="display:none;">${this.out('Delete Selected')}</button>
                        <button class="btn-toggle-select tooltipx relative ml-2" title="${this.out('Select')}"><svg class="mr-1"><use xlink:href="#icon-files"></use></svg><span>${this.out('Select')}</span></button>
                        
                        <button class="btn-settings tooltipx relative ml-2" title="${this.out('More')}" style="width:55px;height:44px"><svg style="width:19px;height:19px"><use xlink:href="#icon-dots-vertical"></use></svg></button>
                ...
                <div class="file-list-wrapper">
                    ...
                    <div class="file-info">
                        ...
                        <button class="btn-close tooltipx" title="${this.out('Close')}">
                        ...
                        <div class="file-info-details">
                            ...
                            <div class="flex mt-5">
                                <button class="btn-edit w-full mr-1 tooltipx relative" title="${this.out('Edit')}">
                                    <svg style="width:19px;height:19px;margin-right:4px"><use xlink:href="#icon-edit"></use></svg>
                                </button>
                                <button class="btn-view w-full mr-1 tooltipx relative" title="${this.out('View')}">
                                    <svg style="width:19px;height:19px;margin-right:4px"><use xlink:href="#icon-zoom-in"></use></svg>
                                </button>
                                <button class="btn-download w-full mr-1 tooltipx relative" title="${this.out('Download')}">
                                    <svg style="width:19px;height:19px;margin-right:4px"><use xlink:href="#icon-download"></use></svg>
                                </button>
                                <button class="btn-open w-full tooltipx relative" title="${this.out('Open')}">
                                    <svg style="width:19px;height:19px;margin-right:4px"><use xlink:href="#icon-open"></use></svg>
                                </button>
                            </div>
                            
                            <div class="flex mt-1">
                                <button class="btn-upscale px-3 w-full mr-1 tooltipx relative" title="${this.out('Upscale')}">
                                    <svg style="width:20px;height:20px;margin-right:4px"><use xlink:href="#icon-upscale"></use></svg>
                                </button>
                                <button class="btn-control-image px-3 w-full tooltipx relative" title="${this.out('Use as image control')}">
        ...
        <div class="is-pop pop-rename">
            ...
            <input type="text" class="inp-rename-to p-2 rounded mb-4" value="">
        ...
        <div class="is-pop pop-settings">
            ...
            <div class="flex">
                <button class="btn-view-list w-full mr-1 tooltipx relative" title="${this.out('View as List')}">
                    <svg><use xlink:href="#icon-list"></use></svg>
                    <span>${this.out('List')}</span>
                </button>
                <button class="btn-view-icons w-full mr-1 tooltipx relative hidden" title="${this.out('View as Icons')}">
                    <svg><use xlink:href="#icon-icons"></use></svg>
                    <span>${this.out('Icons')}</span>
                </button>
                <button class="btn-view-thumbnails w-full mr-1 tooltipx relative" title="${this.out('View as Gallery')}">
            ...
            <div class="gallery-settings flex mt-5" style="display:none">
                <button class="btn-gallery-xs w-full mr-1 tooltipx relative" title="${this.out('XS')}">
                    <span>${this.out('XS')}</span>
                </button>
                <button class="btn-gallery-sm w-full mr-1 tooltipx relative" title="${this.out('SM')}">
                    <span>${this.out('SM')}</span>
                </button>
                <button class="btn-gallery-m w-full mr-1 tooltipx relative" title="${this.out('M')}">
                    <span>${this.out('M')}</span>
                </button>
                <button class="btn-gallery-lg w-full mr-1 tooltipx relative" title="${this.out('LG')}">
                    <span>${this.out('LG')}</span>
                </button>
                <button class="btn-gallery-xl w-full mr-1 tooltipx relative" title="${this.out('XL')}">
    ...
    */
    ...
    const tooltipElements = document.querySelectorAll('.tooltipx');
      ...
      if (item.type === 'folder') {
        ...
        if (!iconsOnly && (ext === 'jpg' || ext === 'jpeg' || ext === 'png' || ext === 'gif' || ext === 'webp' || ext === 'bmp' || ext === 'tiff')) {
          ...
          if (!this.filesOnly) {
            ...
            btnAddControlImage.className = 'btn-control-image tooltipx';
            ...
            if (item.name.includes('-lg.')) {
              ...
              btnUpscale.className = 'btn-upscale tooltipx';
        ...
        if (ext === 'jpg' || ext === 'jpeg' || ext === 'png' || ext === 'gif' || ext === 'webp' || ext === 'bmp' || ext === 'tiff' || ext === 'mp4' || ext === 'mov' || ext === 'mp3' || ext === 'pdf') {
          ...
          btnZoomIn.className = 'btn-view tooltipx';
          ...
          btnEdit.className = 'btn-edit tooltipx';
        ...
        btnTrash.className = 'btn-trash tooltipx';
        ...
        btnDownload.className = 'btn-download tooltipx';
        ...
        btnInfo.className = 'btn-info tooltipx';
  ...
  async fetchFolderContents(folderPath) {
    ...
    const response = await fetch(this.settings.listFilesUrl, {
      ...
      headers: {
        'Content-Type': 'application/json',
        'X-Requested-With': 'XMLHttpRequest' // 🔑 AJAX kontrolü için gerekli
      }
    });
