        ...
        <div class="kl-iosslider hideControls">
            <?php foreach (getAllSlides() as $slide){ ?>
                <div class="item iosslider__item">
                    ...
                    <div class="kl-slide-overlay"></div>
                    <div class="container kl-iosslide-caption kl-ioscaption--style5 zoomin klios-aligncenter kl-caption-posv-middle">
                        <div class="animateme" data-when="span" data-from="0" data-to="0.75" data-opacity="0.1" data-easing="linear">
                            <?php if(!empty($slide->title)){ ?>
                                <h2 class="main_title has_titlebig kl-ios-has-sqbox"><span class="kl-ios-sqbox"></span><span><strong><?php echo $slide->title ?></strong></span></h2>
                            <?php } ?>
                            <?php if(!empty($slide->desc1)){ ?>
                                <h5 class="title_big" style="font-size: 19px">
                                    <strong><?php echo $slide->desc1; ?></strong>
                                </h5>
                            <?php } ?>
                            <?php if(!empty($slide->button_url)){ ?>
                                <div class="more">
                                    <a href="<?php echo $slide->button_url; ?>" target="_self" class="btn btn-fullcolor" title="<?php echo $slide->title ?>"><?php echo $slide->button_caption; ?></a>
                                </div>
                            <?php } ?>
