<div class="kl-slideshow static-content__slideshow uh_light_gray maskcontainer--mask5 scrollme">
    <div class="bgback"></div>
    <div class="kl-slideshow-inner static-content__wrapper min-800 d-flex">
            ...
            <div class="kl-slideshow-safepadding sc__container animateme" data-when="span" data-from="0" data-to="0.75" data-translatey="200" data-opacity="0.1" data-easing="linear">
                <div class="static-content textpop-style">
                    <div class="textpop__texts">
                        <span class="textpop__line1">HEY THERE!</span>
                        <span class="textpop__line2">I'M KALLYAS</span>
                        <span class="textpop__line3">AN EPIC / WONDERFUL / PREMIUM</span>
                        <span class="textpop__line4">TEMPLATE</span>
                    </div>
                    <div class="static-content__infopop fadeBoxIn" data-arrow="top">
                        <a href="#" target="_blank" class="sc-infopop__btn"  title="Kallyas">BUY NOW</a>
                        <h5 class="sc-infopop__text">
                            <strong>exclusive on</strong> themeforest.net
                        </h5>
                        <div class="clear"></div>
                    </div>
                </div>
    ...
    <div class="kl-bottommask kl-bottommask--mask5">
        <svg width="2700px" height="64px" class="svgmask" viewBox="0 0 2700 64" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <path d="M1892,0 L2119,44.993 L2701,45 L2701.133,63.993 L-0.16,63.993 L1.73847048e-12,45 L909,44.993 L1892,0 Z" class="bmask-bgfill" fill="#ffffff" filter="url(#filter-mask5)"></path>
