<div class="kl-slideshow static-content__slideshow">
    ...
    <div class="kl-slideshow-inner static-content__wrapper static-content--height min-500 d-flex">
        <div class="static-content__source">
            <div class="kl-bg-source">
                <?php if(!empty($items->logo)) { ?>
                    <div class="kl-bg-source__bgimage" style="background-image: url(<?php echo $items->logo ;?>); background-repeat: repeat; background-attachment: scroll; background-position-x: center; background-position-y: center; background-size: cover;"></div>
                <?php } else { ?>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-7 mb-30 align-self-center">
                            <?php if(!empty($items->breadcrumbTitle)) { ?>
                                <h2 class="static-content__title istShadow" style="font-size: 40px;margin: 0px"><?= $items->breadcrumbTitle ?></h2>
                            <?php } else { ?>
                                <h2 class="static-content__title istShadow"><?= $items->title ?></h2>
                            <?php } ?>
