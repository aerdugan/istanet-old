...
<div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
    <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
        <h1 class="page-heading d-flex flex-column justify-content-center text-gray-900 fw-bold fs-3 m-0">Plugin Ayarları</h1>
        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
            ...
            <li class="breadcrumb-item text-muted">Plugin Ayarları</li>
        </ul>
    </div>
    <div class="d-flex align-items-center gap-2 gap-lg-3">
        <a href="#" class="btn btn-sm btn-primary"  data-bs-toggle="modal" data-bs-target="#iwNewHeader">Yeni Plugin Ekle</a>
    </div>
</div>
<?= $this->endSection() ?>
        ...
        <div class="card-body pt-60">
            <table id="kt_datatable_responsive_2" class="table table-striped border rounded gy-5 gs-7 p-5 content-container">
                ...
                <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                    ...
                    <th class="text-start min-w-400px">Plugin Adı</th>
                </tr>
                </thead>
                ...
                <?php foreach ($files as $file): ?>
                    ...
                    <tr>
                        ...
                        <td class="text-start pe-0">
                            <a href="/admin/plugin/pluginEdit/<?= $file ?>" class="btn btn-light-primary btn-sm">Düzenle</a>
                            ...
                            <a href="/admin/plugin/pluginView/<?= $file ?>" target="_blank" class="btn btn-light-info btn-sm">Görüntüle</a>
                        </td>
                    </tr>
                    <div class="modal fade" id="headerUpdate<?= $file ?>" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered mw-750px">
                            <div class="modal-content">
                                <form class="form" action="/admin/plugin/pluginRename/<?= $file ?>" method="post">
                                    <?= csrf_field() ?>
                                    <div class="modal-header">
                                        <h2 class="fw-bolder">Plugin Adı Düzenle</h2>
                                        ...
                                        <div class="scroll-y me-n7 pe-7" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px">
                                            <div class="row g-9 mb-7">
                                                <div class="col-md-12 fv-row">
                                                    <label class="required form-label" for="newName">Plugin Adı</label>
...
<div class="modal fade" id="iwNewHeader" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mw-750px">
        <div class="modal-content">
            <form class="form" action="/admin/plugin/pluginStore" method="post">
                <?= csrf_field() ?>
                <div class="modal-header">
                    <h2 class="fw-bolder">Yeni Plugin Ekle</h2>
                    <div class="btn btn-icon btn-sm btn-active-icon-primary" data-bs-dismiss="modal" aria-label="Close">
                        <span class="svg-icon svg-icon-1">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                <rect opacity="0.5" x="6" y="17.3137" width="16" height="2" rx="1" transform="rotate(-45 6 17.3137)" fill="black" />
                    ...
                    <div class="scroll-y me-n7 pe-7" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px">
                        <div class="row g-9 mb-7">
                            <div class="col-md-12 fv-row">
                                ...
                                <input type="text" name="name" id="name" class="form-control mb-2 form-control-solid" placeholder="Plugin Adı" value="" />
                            </div>
                        </div>
                    </div>
                </div>
    ...
    function confirmDelete(fileName) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = '/admin/plugin/pluginDelete/' + fileName;
            }
        });
    }
</script>
