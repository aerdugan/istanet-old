...
<div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
    ...
    <div class="d-flex align-items-center gap-2 gap-lg-3">
        <a href="#" class="btn btn-sm btn-primary"  data-bs-toggle="modal" data-bs-target="#iwNewHeader">Yeni BreadCrumb Ekle</a>
    </div>
</div>
<?= $this->endSection() ?>
    ...
    <div class="card-body pt-60">
        <table id="kt_datatable_responsive_2" class="table table-striped border rounded gy-5 gs-7 p-5 content-container">
            ...
            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                ...
                <th class="text-start min-w-400px">BreadCrumb Adı</th>
            </tr>
            </thead>
            ...
            <?php foreach ($files as $file): ?>
                ...
                <tr>
                    ...
                    <td class="text-start pe-0">
                        <a href="/admin/template/breadCrumbEdit/<?= $file ?>" class="btn btn-light-primary btn-sm">Düzenle</a>
                ...
                <div class="modal fade" id="headerUpdate<?= $file ?>" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered mw-750px">
                        <div class="modal-content">
                            <form class="form" action="/admin/template/breadCrumbRename/<?= $file ?>" method="post">
                                <?= csrf_field() ?>
                                    ...
                                    <div class="scroll-y me-n7 pe-7" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px">
                                        <div class="row g-9 mb-7">
                                            <div class="col-md-12 fv-row">
                                                <label class="required form-label" for="newName">Bread Crumb Adı</label>
...
<div class="modal fade" id="iwNewHeader" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mw-750px">
        <div class="modal-content">
            <form class="form" action="/admin/template/breadCrumbStore" method="post">
                <?= csrf_field() ?>
                <div class="modal-header">
                ...
                <div class="modal-body py-10 px-lg-17">
                    <div class="scroll-y me-n7 pe-7" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px">
                        <div class="row g-9 mb-7">
                            <div class="col-md-12 fv-row">
                                <label class="required form-label">BreadCrumb Adı</label>
                                <input type="text" name="name" id="name" class="form-control mb-2 form-control-solid" placeholder="BreadCrumb Adı" value="" />
                            </div>
                        </div>
                    </div>
                </div>
    ...
    function confirmDelete(fileName) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = '/admin/template/breadCrumbDelete/' + fileName;
            }
        });
    }
</script>
