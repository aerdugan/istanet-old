...
<div class="card mb-5 mb-xl-4">
    <div class="card-body pt-60">
        ...
        <form class="form" action="/admin/template/sliderUpdate/<?= $folder ?>" method="post">
            <?= csrf_field() ?>

            <div class="card card-flush content-container">
                <div class="col-xl-12">
                    <?= $folder ?> dosyasını düzenliyorsunuz.
                </div>
            ...
            <div class="modal-footer flex-right text-end">
                <a href="/admin/template/slider" class="href btn btn-danger me-3 ">Geri</a>
...
<script type="text/javascript">
    ...
    $(function() {var editor = CodeMirror.fromTextArea(document.getElementById("editorJs3"), {lineNumbers: true, matchBrackets: true, mode: "application/x-httpd-php", indentUnit: 4, indentWithTabs: true});});
</script>
