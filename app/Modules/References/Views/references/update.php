...
<form action="<?= base_url("references/update/" . $item['id']) ?>" class="form d-flex flex-column flex-lg-row" method="post">
    <?= csrf_field() ?>
    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                    ...
                    <div class="card-body pt-0">
                        <div class="d-flex flex-wrap gap-5">
                            <div class="fv-row w-100 flex-md-root">
                                ...
                                <select class="form-select mb-2 form-control-solid" name="category_id[]" multiple data-control="select2" data-placeholder="Kategori seçin">
        ...
        <div class="d-flex justify-content-end">
            <a href="<?= base_url("references") ?>" class="btn btn-light me-5">İptal</a>
