...
<?= $this->section('content') ?>
    <form action="<?php echo base_url("blogs/store"); ?>" class="form d-flex flex-column flex-lg-row" method="post">
        <?= csrf_field() ?>
        <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
            ...
            <div class="d-flex justify-content-end">
                <a href="<?php echo base_url("blogs") ?>" id="kt_ecommerce_add_product_cancel" class="btn btn-light me-5">İptal</a>
