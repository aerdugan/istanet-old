...
<?= $this->section('breadCrumbs') ?>
    <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
        <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
            <h1 class="page-heading d-flex flex-column justify-content-center text-gray-900 fw-bold fs-3 m-0">Kullanıcı Listesi</h1>
            ...
            <div class="card-body p-9">
                <div class="row mb-8">
                    ...
                    <div class="col-xl-4 fv-row">
                        <input type="email" name="email" class="form-control form-control-solid" value="<?= esc($user->email) ?>" required>
                    </div>
                </div>
                <div class="row mb-8">
                    <div class="col-xl-3">
                    ...
                    <div class="col-xl-4 fv-row">
                        <input type="text" name="username" class="form-control form-control-solid" value="<?= esc($user->username ?? '') ?>">
                    </div>
                </div>
                <div class="row mb-8">
                    <div class="col-xl-3">
                    ...
                    <div class="col-xl-8 fv-row">
                        <div class="d-flex flex-wrap gap-3">
                            <?php $assigned = array_column($userRoles, 'role_id'); ?>
