...
class CreateMobilethemesettingsTable extends Migration
{
    public function up()
    {
        $this->forge->addField([
            'id' => ['type' => 'INT', 'unsigned' => true, 'constraint' => 11, 'null' => false],
            'theme' => ['type' => 'INT', 'unsigned' => true, 'constraint' => 11, 'null' => false],
            ...
            'setMobileTheme' => ['type' => 'INT', 'unsigned' => true, 'constraint' => 11, 'null' => false],
            'setMobileHeader' => ['type' => 'INT', 'unsigned' => true, 'constraint' => 11, 'null' => false],
            'setMobileLogo' => ['type' => 'INT', 'unsigned' => true, 'constraint' => 11, 'null' => false],
            'mobileHeaderSocial' => ['type' => 'TINYINT', 'unsigned' => true, 'constraint' => 4, 'null' => false],
            'mobileHeaderLang' => ['type' => 'TINYINT', 'unsigned' => true, 'constraint' => 4, 'null' => false],
            'setMobileFooter' => ['type' => 'INT', 'unsigned' => true, 'constraint' => 11, 'null' => false],
            'setMobileFooterLogo' => ['type' => 'INT', 'unsigned' => true, 'constraint' => 11, 'null' => false],
            'mobileFooterSocial' => ['type' => 'TINYINT', 'unsigned' => true, 'constraint' => 4, 'null' => false],
            'mobileFooterContact' => ['type' => 'TINYINT', 'unsigned' => true, 'constraint' => 4, 'null' => false],
            'mobileFooterNewsLetter' => ['type' => 'TINYINT', 'unsigned' => true, 'constraint' => 4, 'null' => false],
            'setMobileSlider' => ['type' => 'INT', 'unsigned' => true, 'constraint' => 11, 'null' => false],
            'setMobileBreadcrumb' => ['type' => 'INT', 'unsigned' => true, 'constraint' => 11, 'null' => false],
            'mobileBreadcrumbStatus' => ['type' => 'TINYINT', 'unsigned' => true, 'constraint' => 4, 'null' => false],
        ...
        $this->forge->createTable('mobileThemeSettings', true, ['ENGINE' => 'InnoDB', 'DEFAULT' => 'utf8mb4']);
    }

    public function down()
    {
        $this->forge->dropTable('mobileThemeSettings', true);
    }
}
